...
namespace Tedd {
    public ref partial struct SpanStream {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Write(scoped Span<byte> value) => Write(value, out _);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Write(scoped Span<byte> value, out int length)
        {
            SpanUtils.Write(WriteBuffer, value, out length);
            AdvanceWrite(length);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool TryWrite(scoped Span<byte> value) => TryWrite(value, out _);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool TryWrite(scoped Span<byte> value, out int length) {
            if (!SpanUtils.TryWrite(WriteBuffer, value, out length)) return false;
            AdvanceWrite(length);
            return true;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Write(scoped ReadOnlySpan<byte> value) => Write(value, out _);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Write(scoped ReadOnlySpan<byte> value, out int length)
        {
            SpanUtils.Write(WriteBuffer, value, out length);
            AdvanceWrite(length);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool TryWrite(scoped ReadOnlySpan<byte> value) => TryWrite(value, out _);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool TryWrite(scoped ReadOnlySpan<byte> value, out int length) {
            if (!SpanUtils.TryWrite(WriteBuffer, value, out length)) return false;
            AdvanceWrite(length);
            return true;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteSized(scoped Span<byte> value) => WriteSized(value, out _);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteSized(scoped Span<byte> value, out int length)
        {
            SpanUtils.WriteSized(WriteBuffer, value, out length);
            AdvanceWrite(length);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool TryWriteSized(scoped Span<byte> value) => TryWriteSized(value, out _);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool TryWriteSized(scoped Span<byte> value, out int length) {
            if (!SpanUtils.TryWriteSized(WriteBuffer, value, out length)) return false;
            AdvanceWrite(length);
            return true;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteSized(scoped ReadOnlySpan<byte> value) => WriteSized(value, out _);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteSized(scoped ReadOnlySpan<byte> value, out int length)
        {
            SpanUtils.WriteSized(WriteBuffer, value, out length);
            AdvanceWrite(length);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool TryWriteSized(scoped ReadOnlySpan<byte> value) => TryWriteSized(value, out _);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool TryWriteSized(scoped ReadOnlySpan<byte> value, out int length) {
            if (!SpanUtils.TryWriteSized(WriteBuffer, value, out length)) return false;
            AdvanceWrite(length);
            return true;
        }
