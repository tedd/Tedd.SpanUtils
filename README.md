...
If you want to know how many bytes the number is, simply do (firstByte>>6)+1. The result is 1-4. The `MeasureWriteSize()` extension method can be used on a `UInt32` to calculate the required bytes for a sizing operation.
