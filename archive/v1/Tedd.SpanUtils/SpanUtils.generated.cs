...
namespace Tedd {
    public static partial class SpanUtils {
        ...
        public static unsafe Decimal ReadDecimal(Span<byte> span, out int length) {
            ...
            var r = Unsafe.ReadUnaligned<Decimal>(ref MemoryMarshal.GetReference(span));
        ...
        public static unsafe Char ReadChar(Span<byte> span, out int length) {
            if (span.Length < sizeof(Char))
                throw new ArgumentOutOfRangeException();
            var r = Unsafe.ReadUnaligned<Char>(ref MemoryMarshal.GetReference(span));
            length = sizeof(Char);
        ...
        public static unsafe Byte[] ReadBytes(Span<byte> span, int length) {
            if (span.Length < sizeof(Boolean))
                throw new ArgumentOutOfRangeException();
            var r = Unsafe.ReadUnaligned<Boolean>(ref MemoryMarshal.GetReference(span));
