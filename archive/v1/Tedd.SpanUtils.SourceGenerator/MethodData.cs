...
namespace Tedd.SpanUtils.SourceGenerator
{
    ...
    public class MethodData
    {
        ...
        public string GetReadName(Endianness le)
        {
            return "Read" + Name + CodeGenBodies.EndiannessToMethodExtension(le);
        }
        public string GetWriteName(Endianness le)
        {
            return "Write" + WriteName + CodeGenBodies.EndiannessToMethodExtension(le);
        }
    }
}